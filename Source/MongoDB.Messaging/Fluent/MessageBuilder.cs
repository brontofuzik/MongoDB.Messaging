...
namespace MongoDB.Messaging.Fluent
{
    ...
    public class BatchBuilder
    {
        ...
        private readonly IQueueContainer queueContainer;

        public BatchBuilder(IList<Message> messages, IQueueContainer queueContainer)
        {
        ...
        {
            var message = new Message {State = MessageState.Queued};
            queueContainer.ApplyDefaults(message);
