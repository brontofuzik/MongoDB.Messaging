...
namespace MongoDB.Messaging
{
    ...
    public class MessageQueue
    {
        ...
        public Task<IList<Message>> Publish(Action<PublishQueueBuilder> builder)
        {
            if (builder == null)
            ...
            var publishBuilder = new PublishQueueBuilder(_manager, messages);
            ...
            return container.Repository.Enqueue(messages);
        }
